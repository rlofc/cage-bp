...
#    distribution.
CC = gcc
CFLAGS = `sdl2-config --cflags` -I$(CAGEDIR)/src/ -c
CFLAGS += -O3
# CFLAGS += -g3
ifeq ($(UNAME_S),Linux)
	CFLAGS += -std=c89
...
LDFLAGS =
LIBRARIES = `sdl2-config --static-libs` -L$(CAGEDIR)/build/ -lSDL2_image -lSDL2_mixer -lcage
...
$(BINARY): $(OBJECTS) $(CAGEDIR)/build/libcage.a
	@mkdir -p build
